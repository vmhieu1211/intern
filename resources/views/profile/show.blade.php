        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="cart-table">
                        <h3>Order {{ $order->order_number }}
                            <strong class="text-uppercase text-danger">{{ $order->status->name }}</strong>
                        </h3>
                                        ...
                                        <tr>
                                            <td class="product-col">
                                                {{-- @if ($p->model->photos->count() > 0)
                                                    <img src="/storage/{{ $p->pivot->photos->first()->images }}"
                                                        alt="">
                                                @else
                ...
                <div class="col-lg-4 card-right">
                    <a href="" class="site-btn">Cài đặt hồ sơ</a>
