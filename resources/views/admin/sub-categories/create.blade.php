...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form
                action="{{ isset($subCategory) ? route('subcategories.update', $subCategory->slug) : route('subcategories.store') }}"
                method="POST">
                @csrf
                ...
                <div class="row justify-content-start">
                    ...
                    <div class="form-group ml-5">
                        <input type="text" name="name" id="name"
                            class="form-control @error('name') is-invalid @enderror" placeholder="Add sub-category"
				...
				@endif --}}
                    ...
                    <div class="form-group ml-5">
                        <button type="submit"
                            class="btn btn-primary">{{ isset($subCategory) ? 'Edit Sub-Cat' : 'Add Sub-category' }}</button>
                    </div>
